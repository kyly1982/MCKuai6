...
import com.mckuai.imc.adapter.UserCentPostAdapter;
import com.mckuai.imc.bean.MCDynamic;
import com.mckuai.imc.bean.MCDynamicBean;
import com.mckuai.imc.bean.MCMessage;
import com.mckuai.imc.bean.MCMessageBean;
import com.mckuai.imc.bean.Post;
import com.mckuai.imc.bean.PostBean;
import com.mckuai.imc.bean.User;
import com.mckuai.imc.fragment.MCSildingMenu;
import com.mckuai.imc.until.FastBlur;
		...
		OnClickListener, OnItemClickListener, XListView.IXListViewListener
{
	...
	private com.mckuai.imc.widget.CircleImageView iv_User;
	...
	private PostBean mPostBaen = new PostBean();// 当前的作品
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		mCircle = application.getCircleOptions();
	...
	private void initView()
	{
		...
		iv_User = (com.mckuai.imc.widget.CircleImageView) findViewById(R.id.prg_UserHead);
	...
	private void showUser()
	{
		...
		if (null != user)
		{
					...
					&& !url.equalsIgnoreCase(user.getHeadImg()))
			{
				...
				{
					image = new UMImage(this, R.mipmap.icon_share_default);
				}
...
//						+ getString(R.string.loadfaile_context) + throwable.getLocalizedMessage());
	...
	private void parsePost(String url, JSONObject post, boolean enableCache)
	{
		...
		if (post.has("list"))
		{
			...
			try
			{
				bean = mGson.fromJson(post.getString("list"), PostBean.class);
			} catch (JsonSyntaxException e)
			{
				// TODO Auto-generated catch block
				e.printStackTrace();
	...
	{
		user = mGson.fromJson(userString, User.class);
		if (!isOther)
		{
...
//		int postid = 0;
		...
		case GROUP_DYNAMIC:
			...
			post.setTalkTitle(dynamic.getTalkTitle());
			break;
		case GROUP_POST:
