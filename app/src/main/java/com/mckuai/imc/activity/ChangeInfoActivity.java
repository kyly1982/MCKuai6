...
public class ChangeInfoActivity extends BaseActivity implements OnClickListener, OnEditorActionListener
{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		options = application.getCircleOptions();
	...
	private void showData()
	{
		if (null != user)
		{
			...
			{
				civ_cover.setImageResource(R.mipmap.background_user_cover_default);
			}
		}
	}
